  ...
  return (
    <div className="min-h-screen lg:h-screen w-full flex flex-col lg:flex-row bg-background overflow-x-hidden">
      {/* =========================================================================
          ...
          ========================================================================= */}
      <header className="lg:hidden fixed top-0 left-0 right-0 h-14 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 z-30 px-4 flex items-center justify-between shadow-2xs">
        <button
        ...
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-lg overflow-hidden border border-slate-200 bg-white flex items-center justify-center shadow-2xs">
            <Image
              src="/images/Logo.jpg"
              alt="Logo RSUD"
              width={26}
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-50 h-full w-72 max-w-[80vw] bg-white dark:bg-slate-900 shadow-2xl flex flex-col",
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-100 dark:border-slate-800 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl overflow-hidden border border-slate-200 bg-white flex items-center justify-center shadow-2xs">
              <Image
                src="/images/Logo.jpg"
                alt="Logo RSUD"
                width={34}
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[11px] font-medium text-blue-600 dark:text-blue-400 leading-tight">
                SIPINTAR PKRS
              </span>
            </div>
          </div>
                        ...
                        <Link
                          ...
                          className={cn(
                            ...
                            isSubCurrent
                              ...
                              : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50"
                          )}
                        >
                          <span
                            className={cn(
        ...
        <div className="p-3 border-t border-slate-100 dark:border-slate-800 shrink-0">
          <button
            ...
            className="w-full flex items-center gap-3 px-3.5 py-3 rounded-2xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-all cursor-pointer"
          >
      ...
      {/* =========================================================================
          3. DESKTOP SIDEBAR (lg+ / >= 1024px)
          ========================================================================= */}
      <aside
        className={cn(
          "hidden lg:flex flex-col h-screen bg-white dark:bg-slate-900 border-r border-slate-200/80 dark:border-slate-800",
          "transition-all duration-300 ease-in-out shrink-0 select-none z-20 relative",
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 h-14 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 z-30 shadow-lg flex items-center justify-around px-2">
        {navItems.map((item) => {
          const isActive =
            pathname === item.href ||
            item.subItems?.some(
        ...
        <button
          onClick={handleLogout}
          className="flex-1 flex flex-col items-center justify-center py-1 gap-1 text-[10px] font-semibold text-slate-400 hover:text-rose-500 transition-colors cursor-pointer"
        >
